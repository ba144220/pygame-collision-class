# 這裡目的是讓 Block.number 顯示出來
# 詳見 block.py

import sys
import pygame
# 這裡把 pygame.init() 拿到前面，是因為要先 init 後 pygame 才能讀取字體
# (在 block.py -> class Block -> font = font.SysFont("Arial", 25))
# init 後再 import block 才不會有問題
# 註: 這是在我的架構下才會有的問題，因為我把字體設為 class member
pygame.init()
import random
from utils import *
from block import *
